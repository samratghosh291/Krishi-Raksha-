...
function App() {
  ...
  const analyzeUrl = "https://664a-2409-40e0-1013-f684-9db-4794-7b4-6cdd.ngrok-free.app/analyze";
  const ragUrl ="https://bd49-2409-40e0-1013-f684-d4f7-49cd-b8c1-26d.ngrok-free.app/generate";
  const resetState = () => {
    setError(null);
